  ...
  return (
    <footer className="py-12 mt-12 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Careers Section */}
        <div className="mb-10 p-6 bg-primary/5 rounded-sm">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0 md:mr-8">
              <div className="flex items-center mb-2">
                <UserPlus size={18} className="text-primary mr-2" />
                <h3 className="font-serif text-xl">careers at <span className="text-primary">belong</span></h3>
              </div>
              <p className="text-text/80 max-w-2xl">
                Join a team that's creating homes where people truly <span className="text-primary">belong</span>. We hire for heart first, skills second.
                Our approach to staffing is centered on finding individuals who share our vision of dignity, community, and personalized care.
              </p>
            </div>
            <Link 
              to="/for-professionals#careers" 
              className="bg-primary text-white px-4 py-2 rounded-sm hover:bg-primary/90 transition-colors whitespace-nowrap"
            >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h2 className="font-serif text-2xl"><span className="text-primary">belong</span>.</h2>
